...
import torch
from src.sentiment import cargar_modelo as cargar_sa, entrenar_y_guardar as entrenar_sa
from src.generation import generar_alerta, guardar_modelo as guardar_lm
